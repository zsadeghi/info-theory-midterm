...
public class BitInputStream extends InputStream {
    ...
    /**
     * Open a bit-at-a-time stream that reads from supplied InputStream. If this constructor is used the BitInputStream
     * is not reset-able.
     *
    ...
    /**
     * Return true if the stream has been initialized from a File and is thus reset-able. If constructed from an
     * InputStream it is not reset-able.
     *
    ...
    /**
     * Returns the number of bits requested as rightmost bits in returned value, returns -1 if not enough bits available
